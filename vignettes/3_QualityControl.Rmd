...
Exercises:
1) Generate a "tube_11" object, containing the flowFrame that corresponds
...
2) Generate a "ff_28" object, containing the flowFrame that corresponds
to the cells of the tube 28:
```{r}
fcs_file_28 <- "../inst/extdata/21-10-15_Tube_028.fcs"
tube_28 <- parse_flowjo(fcs_file_28, wsp_file)
ff_28 <- tube_28$flowFrame
ff_28
```
